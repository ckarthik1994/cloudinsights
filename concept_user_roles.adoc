...
NOTE: Be sure the @netapp.com domain is whitelisted in your users' spam filters. If they do not receive the email, they should check their junk or spam folders.
